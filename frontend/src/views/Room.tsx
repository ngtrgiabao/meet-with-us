...
const Room = () => {
  const ROOM_ID = JSON.stringify(window.location?.pathname?.split("/")?.at(2));
  ...
  room.addHostWebcam(isVideo, isAudio, videoRef, ROOM_ID, userID, videoGridRef);
  ...
  return (
    ...
    >
      ...
      <div className={isSharing ? "" : "col-start-5 col-end-8"}>
        ...
        >
          <div className="bg-black/50" id="video-grid" ref={videoGridRef}>
            {isVideo ? (
              <video
                ref={videoRef}
